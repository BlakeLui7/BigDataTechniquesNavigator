...
export const technologies: Technology[] = [
  ...
  // 添加Hadoop
  {
    ...
    icon: "Database",
    description: {
      en: "An open-source framework for distributed storage and processing of large datasets using the MapReduce programming model.",
      zh: "一个使用MapReduce编程模型进行大型数据集分布式存储和处理的开源框架。",
    },
    category: "processing",
    initialRelease: "2006",
    latestVersion: "3.4.1 (2024.10)",
    developedBy: "Apache Software Foundation",
    website: "https://hadoop.apache.org/",
    github: "https://github.com/apache/hadoop",
    documentation: "https://hadoop.apache.org/docs/current/",
    systemRequirements: {
      en: "Java 8+, Linux/Unix environment, 4GB+ RAM",
      zh: "Java 8+，Linux/Unix环境，4GB+内存",
    },
    quickInstall: {
    ...
    features: {
      en: [
        "Distributed File System (HDFS) with Erasure Coding",
        "MapReduce programming model",
        "YARN resource management",
        "Support for multiple standby NameNodes",
        "Improved S3A connector for cloud storage",
    ...
    useCases: {
      en: ["Big data analytics", "Data warehousing", "Log processing", "Machine learning", "ETL operations"],
      zh: ["大数据分析", "数据仓库", "日志处理", "机器学习", "ETL操作"],
    },
  },
  ...
  // 添加Spark
  {
    ...
    icon: "Activity",
    description: {
      en: "A unified analytics engine for large-scale data processing with built-in modules for SQL, streaming, machine learning and graph processing.",
      zh: "一个用于大规模数据处理的统一分析引擎，内置SQL、流处理、机器学习和图形处理模块。",
    },
    category: "processing",
    initialRelease: "2014",
    latestVersion: "3.5.5 (2025.2)",
    developedBy: "Apache Software Foundation",
    website: "https://spark.apache.org/",
    github: "https://github.com/apache/spark",
    documentation: "https://spark.apache.org/docs/latest/",
    systemRequirements: {
      en: "Java 8+, Scala 2.12+, Python 3.7+, 8GB+ RAM",
      zh: "Java 8+，Scala 2.12+，Python 3.7+，8GB+内存",
    },
    quickInstall: {
      en: "Download and extract the latest release, run bin/spark-shell for interactive Scala shell or bin/pyspark for Python",
      zh: "下载并解压最新版本，运行bin/spark-shell获取交互式Scala环境或bin/pyspark获取Python环境",
    },
    dockerCommand: "docker run -p 8080:8080 -p 7077:7077 apache/spark:latest",
    downloadLink: "https://spark.apache.org/downloads.html",
    releaseNotesLink: "https://spark.apache.org/releases/",
    features: {
      en: [
        "In-memory computing capabilities",
        "Fault tolerance through RDDs (Resilient Distributed Datasets)",
        "Support for multiple languages (Scala, Java, Python, R)",
        "Spark SQL for structured data processing",
        "MLlib for machine learning",
        "GraphX for graph processing",
        "Structured Streaming for real-time analytics",
        "Enhanced integration with Delta Lake and Spark Connect",
      ],
      zh: [
        "内存计算能力",
        "通过RDD（弹性分布式数据集）实现容错",
    ...
    useCases: {
      ...
      zh: ["实时分析", "机器学习管道", "交互式数据分析", "流处理", "图计算"],
    },
  },
  ...
  // 添加HBase
  {
    ...
    icon: "Database",
    description: {
      en: "A distributed, scalable, big data store, modeled after Google's Bigtable and built on top of HDFS.",
      zh: "一个分布式、可扩展的大数据存储系统，模仿Google的Bigtable并构建在HDFS之上。",
    },
    category: "collection",
    initialRelease: "2008",
    latestVersion: "2.6.2 (2025.4)",
    developedBy: "Apache Software Foundation",
    website: "https://hbase.apache.org/",
    github: "https://github.com/apache/hbase",
    documentation: "https://hbase.apache.org/book.html",
    systemRequirements: {
      en: "Java 8+, Hadoop environment, 8GB+ RAM",
      zh: "Java 8+，Hadoop环境，8GB+内存",
    },
    quickInstall: {
      en: "Download and extract the latest release, configure hbase-site.xml, run bin/start-hbase.sh",
      zh: "下载并解压最新版本，配置hbase-site.xml，运行bin/start-hbase.sh",
    },
    dockerCommand: "docker run -p 16000:16000 -p 16010:16010 harisekhon/hbase:latest",
    downloadLink: "https://hbase.apache.org/downloads.html",
    releaseNotesLink: "https://hbase.apache.org/book.html#release_notes",
    features: {
      en: [
        ...
        "Dual file compaction algorithm (2.6.x)",
    ...
    useCases: {
      en: [
        ...
        "Hosting of large tables with billions of rows and millions of columns",

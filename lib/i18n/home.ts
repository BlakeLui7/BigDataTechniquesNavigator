...
export const home = {
  ...
  de: {
    ...
    featuredDescription: "Entdecken Sie die beliebtesten Big-Data-Technologien, die in modernen Datenpipelines eingesetzt werden.",
    dataCollection: "Datenerfassung",
    dataCollectionDesc: "Tools und Technologien zum Sammeln und Aufnehmen von Daten aus verschiedenen Quellen.",
    dataProcessing: "Datenverarbeitung",
    dataProcessingDesc: "Lösungen zum Transformieren, Anreichern und Analysieren großer Datenmengen.",
  ...
  fr: {
    // Home page
    heroTitle: "Navigateur des Technologies Big Data",
    heroSubtitle: "Votre guide complet des outils modernes de collecte, traitement et visualisation de données.",
    exploreTechnologies: "Explorer les technologies",
    featuredTechnologies: "Technologies en vedette",
    featuredDescription: "Explorez les technologies Big Data les plus populaires utilisées dans les pipelines de données modernes.",
    ...
    dataVisualizationDesc: "Plateformes pour créer des tableaux de bord interactifs et des représentations visuelles des données.",
    documentation: "Documentation",
    documentationDesc: "Guides complets, tutoriels et documents de référence pour chaque technologie.",
  },
  es: {
    // Home page
    heroTitle: "Navegador de Tecnologías Big Data",
    ...
    featuredDescription: "Explore las tecnologías de Big Data más populares utilizadas en los flujos de datos modernos.",
